...
const Navbar = () => {
  ...
  const [cartItemNo, setCartItemNo]=useState<number>(0)
  return (
    <div>
        ...
        <div className="hidden lg:flex justify-between items-center w-full">
          <ul className="flex space-x-3 font-medium text-lg">
            {NavbarArray.map((item: NavbarItemType, index: number) => (
              <li key={index} className="flex items-center gap-0 relative  px-3 py-1 hover:bg-gray-100 cursor-pointer group">
